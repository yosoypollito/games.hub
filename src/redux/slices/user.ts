...
export const userJoinToRoom = createAsyncThunk('user/joinToRoom', async (id:string)=>{
...
const initialState:InitialState<User.Item | null, 'joining.to.room' | 'joined.to.room' | 'join.to.room.failed'> = {
  data:null,
  status: 'idle',
  error: null
}
...
export const userSlice = createSlice({
  ...
  extraReducers(builder) {
    ...
    .addCase(fetchUser.fulfilled, (state, action: PayloadAction<User.Item | null>) => {
